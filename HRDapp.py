        ...
        if self.collide_point(*touch.pos):
            try:
                ...
                for i in range(len(answer_list)):
                    ...
                    for ii in range(4):
                        for iii in range(3):        
                            if abs(answer_list[i+1][ii][iii]//10-answer_list[i][ii][iii]//10)!=0:
                                n+=1
                    if n>5:
                        answer_list[i+1]=self.Trans(answer_list[i+1])
...
class pic_translate(object):
    ...
    def blur_pic(self,gray_list):
        ...
        #cv2.imshow('blurlist',blurlist[0])
        #cv2.waitKey()
        #cv2.destroyAllWindows()
        return blurlist
    ...
    def canny_pic(self,blur_list):
        ...
        #cv2.imshow('cannylist',cannylist[0])
        #cv2.waitKey()
        #cv2.destroyAllWindows()
        return cannylist
